...
class LLMService:
    ...
    def __init__(
        ...
        anthropic_default = app_config.anthropic_model() if provider_name == "anthropic" else None
        self.model_cheap = (
            model_cheap
            or app_config.llm_model_tier("cheap")
            or anthropic_default
            or default_model_for(provider_name, "cheap")
        )
        self.model_medium = (
            model_medium
            or app_config.llm_model_tier("medium")
            or anthropic_default
            or default_model_for(provider_name, "medium")
        )
        self.model_smart = (
            model_smart
            or app_config.llm_model_tier("smart")
            or anthropic_default
